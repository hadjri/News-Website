...
echo "Account: ", htmlspecialchars($user), "<br>";
echo "Member Since ", htmlspecialchars($dateJoined), "<br>";


echo "<log> <a href=\"welcome.php\">Back to main page</a></log>";

$pstmt = $mysqli->prepare("select p_id, title, link, views, p_id, body from stories where username=?");
$pstmt->bind_param('s', $user);
if(!$pstmt){
